/**
* Translated ABNF-formatted SNOMED Common Grammar from https://confluence.ihtsdotools.org/display/DOCSCG/5.1+Normative+Specification
* to ANTLR4 format using http://www.robertpinchbeck.com/abnf_to_antlr/Default.aspx (Version 1.5.1), May 24, 2018
*/
